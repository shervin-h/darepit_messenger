...
class AgoraHome extends StatefulWidget {
  ...
  @override
  AgoraHomeState createState() => AgoraHomeState();
}

class AgoraHomeState extends State<AgoraHome> {
  bool _isLogin = false;
  ...
  void _createClient() async {
    _client = await AgoraRtmClient.createInstance('6c1c41e125f84ec9a8cfa3a9480d5571');
